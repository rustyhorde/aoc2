...
pub fn part_1() -> Result<u32> {
    run_setup_solution::<Vec<String>, usize>(AoCYear::AOC2019, AoCDay::AOCD15, setup, find)
        .map(|_| 0)
}
...
pub fn part_1_bench(bench: u16) -> Result<u32> {
    run_bench_solution::<Vec<String>, usize>(bench, AoCYear::AOC2019, AoCDay::AOCD15, setup, find)
        .map(|_| 0)
}
...
pub fn part_2() -> Result<u32> {
    run_setup_solution::<Vec<String>, usize>(AoCYear::AOC2019, AoCDay::AOCD15, setup, find2)
        .map(|_| 0)
}
...
pub fn part_2_bench(bench: u16) -> Result<u32> {
    run_bench_solution::<Vec<String>, usize>(bench, AoCYear::AOC2019, AoCDay::AOCD15, setup, find2)
        .map(|_| 0)
}
